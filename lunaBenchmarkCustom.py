...
solveCustomMatrix(solver=qa_solver, qubo_matrix=read_json(f'./input/qubo_{dataset}.json'), lidarVectorSize=lidarVectorSize, solutionFile=f'./output/{solver["name"]}_{dataset}.json')